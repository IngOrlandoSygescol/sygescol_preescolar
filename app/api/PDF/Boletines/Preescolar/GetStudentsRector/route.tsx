...
export async function GET(req: any) {
    ...
    let docente = searchParams.get("d");
    ...
    try {
        ...
        const [datosGrupo]: any = await conexion.query(
            `SELECT DISTINCT grupo_nombre, grupo_id, grado_base FROM cga INNER JOIN v_grupos ON grupo_id = cga.b WHERE cga.g = ${docente} AND grado_base = 0`
        );
  
        const grupo = datosGrupo[0].grupo_id;
