...
const Header = ({ children }: Props) => {
  ...
  const setDatos = () => { setHeader(JSON.parse(localStorage?.datosUsu || {})); };
  ...
  useEffect(() => {
    ...
    const datosColegioString = localStorage.getItem('datosColegio');

    if (datosColegioString) {
      const datosColegio = JSON.parse(datosColegioString);
          ...
          <div className="mt-4 flex flex-col gap-1">
            ...
            {localStorage.getItem('rol') == '3' && (
              <>
                ...
                {JSON.parse(localStorage?.datosColegio)?.nombreInst === "Institución Educativa Leonidas Rubio Villegas"
                  && (
                    <MenuItem
                      id={7}
                      setActive={setActive}
                      active={active}
                      target={1}
                      link="https://sygescol.sistemasivhorsnet.com/sygescol2023/planilla_calificaciones_final_preescolar.php"
                      icono={
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                      ...
                      submenu="Planilla Informe Final"
                    />
                  )}
            ...
            {localStorage.getItem('rol') == '1' && (
              <>
                ...
                <MenuItem
                  ...
                  active={active}
                  target={1}
                  link="https://sygescol.sistemasivhorsnet.com/sygescol2023/informe_final.php "
                  icono={
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                  ...
                  submenu="Impresión Informe Final"
                />
